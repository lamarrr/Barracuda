 ...
 *
 */
#ifndef BARRACUDA_KERNELS_MULTIPLY_CUH_
#define BARRACUDA_KERNELS_MULTIPLY_CUH_
...
__global__ inline void ElementwiseMul(size_t n, T const *input_1,
                                      T const *input_2, T *output) {
...
template <typename T, typename ExecutionPolicy =
                          ::bcuda::execution_policy::LinearGridStride>
__global__ inline void ElementwiseMulInplace(size_t n, T *input_1,
                                             T const *input_2) {
  ::bcuda::KernelContext context{gridDim, blockDim, blockIdx, threadIdx};
...
// BARRACUDA_KERNELS_MULTIPLY_CUH_