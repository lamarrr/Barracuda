 ...
 *
 */
#ifndef BARRACUDA_KERNELS_MATH_ACTIVATIONS_CUH_
#define BARRACUDA_KERNELS_MATH_ACTIVATIONS_CUH_
...
__global__ inline void ACos(size_t n, float const *input, float *output) {
...
template <
    typename ExecutionPolicy = ::bcuda::execution_policy::LinearGridStride>
__global__ inline void ACosInplace(size_t n, float *input) {
  ::bcuda::KernelContext context{gridDim, blockDim, blockIdx, threadIdx};
  ...
  for (size_t i = index; i < n; i += stride) {
    input[i] = acosf(input[i]);
  }
}

template <
    typename ExecutionPolicy = ::bcuda::execution_policy::LinearGridStride>
__global__ inline void ACos(size_t n, double const *input, double *output) {
  ::bcuda::KernelContext context{gridDim, blockDim, blockIdx, threadIdx};
...
template <
    typename ExecutionPolicy = ::bcuda::execution_policy::LinearGridStride>
__global__ inline void ACosInplace(size_t n, double *input) {
  ::bcuda::KernelContext context{gridDim, blockDim, blockIdx, threadIdx};
  ...
  for (size_t i = index; i < n; i += stride) {
    input[i] = acos(input[i]);
  }
}

template <
    typename ExecutionPolicy = ::bcuda::execution_policy::LinearGridStride>
__global__ inline void Exp(size_t n, float const *input, float *output) {
  ::bcuda::KernelContext context{gridDim, blockDim, blockIdx, threadIdx};
...
template <
    typename ExecutionPolicy = ::bcuda::execution_policy::LinearGridStride>
__global__ inline void ExpInplace(size_t n, float *input) {
  ::bcuda::KernelContext context{gridDim, blockDim, blockIdx, threadIdx};
...
template <
    typename ExecutionPolicy = ::bcuda::execution_policy::LinearGridStride>
__global__ inline void Exp(size_t n, double const *input, double * output) {
  ::bcuda::KernelContext context{gridDim, blockDim, blockIdx, threadIdx};
...
template <
    typename ExecutionPolicy = ::bcuda::execution_policy::LinearGridStride>
__global__ inline void ExpInplace(size_t n, double *input) {
  ::bcuda::KernelContext context{gridDim, blockDim, blockIdx, threadIdx};
...
__device__ ​ float cyl_bessel_i0f ( float  x )
    Calculate the value of the regular modified cylindrical Bessel function of
...
__device__ ​ float nextafterf ( float  x, float  y )
    Return next representable single-precision floating-point value afer
argument.
...
__device__ ​ float normf ( int  dim, const float* a )
    Calculate the square root of the sum of squares of any number of
coordinates.
...
__device__ ​ float rnormf ( int  dim, const float* a )
    Calculate the reciprocal of square root of the sum of squares of any number
of coordinates.
...
__device__ ​ float ynf ( int  n, float  x )
    Calculate the value of the Bessel function of the second kind of order n for
the input argument.
...
#endif  // BARRACUDA_KERNELS_MATH_ACTIVATIONS_CUH_
